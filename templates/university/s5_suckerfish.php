...
function mosGetLink( $mitem, $level, $class_sfx='' ) {
    ...
    if ($mitem->cnt > 0) {
				if ($level == 0) {
                $txt = "<span class=\"s5_outer_active\"><span><a href=\"#\" class=\"active\" onClick=\"javascript: window.open('$mitem->link', '', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=780,height=550');\" class=\"$menuclass\">$mitem->name<span class=\"s5_bottom_text\"></span>
</a><span class=\"s5_outerr\"></span></span></span>\n";
		   					$main = "main";
		} else {
                $txt = "<span class=\"s5_outer_active\"><span><a href=\"#\" class=\"active\" onClick=\"javascript: window.open('$mitem->link', '', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=780,height=550');\" class=\"$menuclass\">$mitem->name<span class=\"s5_bottom_text\"></span>
</a><span class=\"s5_outerr\"></span></span></span>\n";
		    ...
		    $txt = "<span class=\"s5_outer_active\"><span><a href=\"#\" onClick=\"javascript: window.open('$mitem->link', '', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=780,height=550');\" class=\"active\">$mitem->name<span class=\"s5_bottom_text\"></span>
</a><span class=\"s5_outerr\"></span></span></span>\n";
		}
